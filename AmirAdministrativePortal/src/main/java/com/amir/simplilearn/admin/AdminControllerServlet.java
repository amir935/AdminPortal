package com.amir.simplilearn.admin;
...
import com.amir.simplilearn.models.Class;
import com.amir.simplilearn.models.Student;
import com.amir.simplilearn.models.Subject;
import com.amir.simplilearn.models.Teacher;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (!getCookies(request, response) && (!command.equals("LOGIN"))) {
				...
				response.sendRedirect("/AmirAdministrativePortal/login.jsp");
			}
